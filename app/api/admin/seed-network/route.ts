    ...
    try {
        ...
        for (const persona of PERSONAS) {
            ...
            const seoSettings = {
                ...
                keywords: ["kurumsal", "hizmet", "danışmanlık", "2026", "deneme bonusu veren siteler"],
            ...
            await prisma.site.upsert({
                ...
                update: {
                    name: persona.name,
                    maskType: persona.maskType as any,
        ...
        return NextResponse.json({ success: true, message: "10 Sites Deployed Successfully!" });
    } catch (error) {
        console.error(error);
